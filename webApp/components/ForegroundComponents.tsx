...
//               <div className="ml-3">
//                 <h3 className="text-yellow-800">
//                   {shortenAddress(props.address)} – Already claimed on{" "}
//                   {chainConfig.HumanNetworkName}.{" "}
//                 </h3>
//               </div>
//             </div>
//           </div>
...
//       // Valid claimant
//       if (txHash !== "") {
//         // If we have a hash, tx has been sent, display it
...
//       if (txError !== "") {
//         // If we have a tx error, tx has been sent and failed, display it
//         return (
//           <div className="p-4">
...
//       if (calculatingProof) {
//         // If the merkle proof is currently being calculated, display loading
//         return <Loading text={"Calculating merkle proof..."}></Loading>;
//       }

//       if (
//         proof.proof === undefined ||
//         proof.root === undefined ||
//         proof.leaf === undefined
//       ) {
//         // Webworker failure
